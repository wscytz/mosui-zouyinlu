...
>
> 当前自动检查：37 smoke + 5 wave + 231 content + 11 stress + 5 robust + 3 seeded + strict audit；视觉冒烟 10 项。`content_test.js` summary 由 `.claude/fix-test-count.js` 校准；高并发测试号由 `.claude/sequencer.js` 分配。
