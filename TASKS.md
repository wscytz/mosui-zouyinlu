...
> 历史归档：此文件记录 v10.0 时期任务，不作为当前 v13.1 开发来源。当前路线看 `ROADMAP.md`，当前规范看 `STRUCTURE_RULES.md`。
...
总预计新增：~250行（game.js 5238+250=5488，在8000上限内）
