...
### v7.0 连杀里程碑重构 (2026-05-18)
- 连杀里程碑6级体系(3/5/10/20/30/50)
- 暴击/闪避统计追踪
- 评分公式加入连斩(maxCombo×0.2)+暴击(critKills×0.15)因子
- game.js ~5150行

*v7.0 更新于 2026-05-18。*

### v7.14-v7.18 战斗打磨 (2026-05-20)
- v7.14: 评分公式优化
- v7.16: 版本号显示(MOSUI.version)
- v7.17: Boss阶段全屏文字提示("狂 暴"/"绝 望")
- v7.18: 低血量警告增强(红色脉冲+屏幕vignette)

*v7.18 更新于 2026-05-20。*

### v9.0 誓印+成就+舞台危害 (2026-05-31)
- 3新誓印：虎卫(huwei)/沧浪(canglang)/潜鸟(qianniao)
- 5新成就（险途征服/画皮克星等）
- 2舞台危害：墨落(moluo，减速) / 鬼影(guiying，恐惧)
- relicsSeen/survivalMaster追踪
- 28誓印 / 47成就 / 8关卡调制器

*v9.0 更新于 2026-05-31。*

### v9.1 4新敌人+4特殊能力 (2026-05-31)
- 墨链电(molian)：chainLightning闪电链攻击(3目标，伤害递增150%)
- 墨魂祭(mohuanji)：soulHarvester记录附近击杀，每5秒+8最大HP
- 墨分身(mofenshen)：cloneOnHalf在50%HP时生成35%HP分身
- 墨噬者(moshihe)：vampiric击杀回血15HP
- STAGE_HAZARDS 6→8，敌人43→47

*v9.1 更新于 2026-05-31。*

### v9.2 武器专属遗物×10 (2026-06-01)
- 10个武器限定遗物（每武器2个），PREREQS用weaponType限定
- melee: 墨断刃(暴击突进) / 墨血剑(命中回血)
- ranged: 墨鬼弹(命中溅射) / 墨射影(击杀加速)
- aoe: 墨魂音(铃声魂伤) / 墨镇灵(铃声减伤)
- dash: 墨影伞(残影反伤) / 墨破风(冲刺后必暴)
- summon: 墨魂坠(魂弹概率爆炸) / 墨链魂(魂击杀回血)
- 新机制：decoy反伤(strikeDmg)、概率爆炸(spiritExplodeChance)、强制暴击(_dashCritPending)
- 遗物193→203，PREREQS 32→42，测试236内容+44冒烟全绿

*v9.2 更新于 2026-06-01。*

### v9.3 Boss行为微调 (2026-06-01)
- **画皮**: HP<60% 触发分身(给玩家前期输出窗口,移出desperate阶段)
- **墨将军**: phase 3 墨盾 shieldRegen 300→480(8秒空窗,原5秒)
- **墨鬼王**: phase 3 每5秒释放8方向朝玩家 snapshot 弹
- 代码位置: game.js:1988-1997(A1) / 2120(A2) / 2188-2194(A3)
- 单元测试: smoke 44/44 + content 236/236 全过
- 完整测试: 600s timeout 待跑(commit 后)

*v9.3 更新于 2026-06-01。*

### v9.4 炼狱难度 (2026-06-01)
- **新增第4难度"炼狱"**：在噩梦基础上再强化(hpM 1.8→2.0/spdM 1.3→1.4/dmgM 1.5→1.55)
- **新机制(仅炼狱)**: 玩家 HP 倍率 0.7(maxHpMult=0.7), 遗物上限 5(maxRelicsOverride=5)
- 精英概率加成 0.3(TUNING.elitePurgatoryBonus, 噩梦 0.18)
- specialWave 池: 噩梦 elite_horde + 炼狱 elite_horde + elite(双重特殊波)
- 中阵 boss 50% 概率: 噩梦/炼狱均跳过(只有平常/险途触发)
- calcGrade 加分: 炼狱 +30(噩梦 +20/险途 +10)
- 新成就: purgatory_win"炼狱行者"(通关后解锁)
- meta: purgatoryWins 统计
- UI: 第 4 个难度按钮 game.html:55-56, 颜色 #8b0000(深红)
- 代码位置: game.js:373 / 389-412 / 455 / 1076 / 212 / 166-167 / 3932 / 4443 / 4701-4702 / 4706-4711; gamedata.js:622 / 683 / 693 / 844
- 单元测试: smoke 44/44 + content 236/236 全过(47→48 成就断言同步)

*v9.4 更新于 2026-06-01。*

### v10.0 视觉升级 (2026-06-01)
- **T1 结算截图**：结算页加"截图保存"按钮，Canvas 960x640→PNG 自动下载(包含评级/武器/击杀/波次/遗物/构筑/路线/版本号)；代码位置: game.html:129 + game.js:4806-4841
- **T2 粒子效果升级**：
  - 暴击: 加 8 墨溅(spawnInk accent 8) + 6 向金粒爆裂(pushLimited gold life:25 size:3-7) — game.js:1533-1537
  - Boss 击杀: 16 向大弹(pushLimited accent life:35 size:5-10) + 15 墨爆炸(spawnInk accent 15) — game.js:932-935
  - 连杀里程碑: 8 向冲击波环(pushLimited accent life:20 size:3-6) — game.js:874-876
  - 粒子颜色 PCOL.gold=gamedata.js:645 已有 gold 支持
- **T3 武器攻击视觉差异化**(g._pm>=0.5 才显示):
  - 斩妖剑 slash: 加 3 径向墨痕拖尾(stroke 短线条) — game.js:2736-2739
  - 符骨笔 proj: 加墨点轨迹(单 ink dot 跟随) — game.js:2756-2757
  - 镇魂铃 ring: 加脉动声波纹(pulseCount=r/30 多环 ivory) — game.js:2770-2773
  - 伏魔伞 dashSlash: 加弧端墨溅(2 ink blob 弧端点) — game.js:2719-2721
  - 召魂幡 spirit: 加光晕环(C.spirit 半透环 spR*2) — game.js:2783-2784
- **T4 战斗回放数据**: localStorage mosui_history(最多5局), 字段 {ts, weapon, weaponName, grade, kills, wave, relics, time, boss, diff}; 结算页 historyPanel 显示近5局(本局高亮+星级 Boss 标记+难度缩略+日期时间) — game.html:126 + game.js:4788-4800
- **T5 本地排行榜**: 
  - calcScore 抽离(原 calcGrade 内联公式), 返回数值分数 — game.js:210-219
  - calcGrade 改用 calcScore — game.js:221-225
  - localStorage mosui_leaderboard(最多20条), 字段 {ts, weapon, grade, score, kills, wave, date, diff}
  - 排序: 评级优先(S>甲>乙>丙>丁), 分数次之
  - 标题页+结算页都加"排行榜"按钮 → leaderboardPanel 面板(评级/武器/击杀/波次/分数/日期) — game.html:138-151 + game.js:4792-4795 + game.js:4845-4859 + game.js:5185-5188
- **T6 敌人画像补充**: 用 mmx image-01 生成 9 张水墨风 jpg(1024x1024): jiangshi/modeng/moyingjiang/moguchong/molingdeng/molian/mohuanji/mofenshen/moshizhe — assets/sprites/enemies/; ETYPE 47/47 全有图标, wiki.html wiki-card__enemy-icon 完整显示

**测试基线:** smoke 44/44 + content 236/236 全过(成就 48 项断言同步)

*v10.0 更新于 2026-06-01。*

### v11.0 无尽模式 + 每日种子 (2026-06-01)
- **T1 无尽模式**: 通关9波后继续战斗，每波敌人增强 HP+10%/速度+5%/伤害+8%，3个无尽成就(15/25/50波)
- **T2 UI checkbox**: game.html 加无尽模式和每日种子勾选框
- **T3 无尽独立排行榜**: 排行榜面板 tab 切换普通榜/无尽榜，按波数降序
- **T4 每日种子**: mulberry32 PRNG 从本地日期字符串生成种子，startWave 中 Math.random swap+try/finally 保护
- **Bug fix**: RNG swap 泄漏修复（try/finally 包裹），UTC 时区改为 localDay() 本地日期

*v11.0 更新于 2026-06-01。*

### v12.0 体验补全 (2026-06-02)
- **T1 首局教学引导**: 首次进入(无mosui_meta)显示操作提示overlay，点击消失
- **T2 代码去重**: DIFF_LABELS/DIFF_SHORT/gradePriority/pushLSCapped/fmtMmSs 提取为helper，消除重复代码
- **T3 关卡调制器池扩展**: 无尽波和Boss波随机池加入guishi(鬼市)/mirror(镜殿)
- **优化**: bossT变量合并(消除遗漏var)，成就toast移至底部(不遮挡副标题)，fmtMmSs统一替换3处内联mm:ss，pick/ri替换Math.random
- **截图修复**: 截图显示无尽/每日标记，波次显示无尽波数
- **Wiki**: 新增"游戏模式"section(4难度+无尽+每日)，遗物卡显示图标(21张)
- **图标**: 22张水墨风遗物图标(assets/ui/relics/)，水墨风favicon(赤月+墨影+红灯笼)

**测试基线:** smoke 44/44 + content 236/236 全过

*v12.0 更新于 2026-06-02。*

## 十三、待办

### v13.0+ 远期
- 第6把武器、第4/5 Boss（需 game.js 模块拆分释放空间）
- Mod支持（数据驱动编辑器）
...
### v6.0 构筑体验深化 + 反馈增强 (2026-05-30)

**目标：** 让玩家更清晰感知核心流派在战斗中生效。

**构筑体验增强（13项联动反馈）：**

| 机制 | 遗物 | 浮字 | 触发条件 |
|------|------|------|----------|
| 墨涟爆 | 墨涟爆 | "爆" | 溅射击杀触发二次爆炸 |
| 火场扩张 | 火祟牙 | "扩" | 磷火击杀扩大范围 |
| 分裂弹幕 | 墨裂符 | "裂" | 命中触发分裂 |
| 暴击碎片 | 墨碎 | "碎" | 暴击溅射有伤害 |
| 暴击爆炸 | 墨火眼 | "爆" | 暴击爆炸有伤害 |
...
**测试：** 325项全绿（37 smoke + 8 wave + 236 content + 11 stress + 5 robust + 3 seeded + strict audit）

*没有改变游戏平衡性。*

*v6.0 更新于 2026-05-30。（共 325 项测试）*

### v6.1 音效补洞 + 恐惧视觉 (2026-05-30)
- 补 3 个新音效：env 危险音/回春音、墨蛊召唤音
- 恐惧视觉化：受恐惧状态敌人头上飘 "惧" 字，缩短玩家识别距离
- 墨医师指示圈颜色加深，治疗触发反馈更清晰

*v6.1 更新于 2026-05-30。*

### v6.2 精英能力 + 3 新敌人 + 3 新誓印 (2026-05-30)
- 精英能力扩 2 种：regen(自动回血)/vampire(击杀回血)
- 新敌人 3 个：墨影将 mozhuhou(高攻传送型)/墨蛊虫 moguchong(召唤流)/墨灵灯 molingdeng(精英自爆)
- 新誓印 3 个：塞翁失马/以血换血/孤注一掷（条件型代价流）
- 敌人 39→42，誓印 25→28

*v6.2 更新于 2026-05-30。*

### v6.3 发布收口 (2026-05-30)
- **v6.3 主体**：自动暂停（alt+tab 切窗暂停）、波次统计、结算页增强、百科筛选
- **v6.3 补充**：波次预览（按 P 预览下波敌人数）、R 键保护（防止误重开）、百科诅咒增益/代价着色
- **v6.3 增强**：光标隐藏（战斗中自动隐藏鼠标）、武器大师追踪（meta）
- **v6.3 进一步**：闪避指示（屏幕边缘提示方向）、击杀提示（击杀 X 连击浮字）、波次标签
- **v6.3 百科**：敌人/进化分类筛选
- **v6.3 进一步**：伤害分色（暴击/处决不同颜色）、操作提示扩展
- **v6.3 UI**：静音按钮、震屏调节
- **v6.3.1**：发布收口 — 加载屏幕、测试修复、README 更新
- **v6.3.2**：修复百科页面 JS 语法错误

*v6.3.x 更新于 2026-05-30。*
...
- **v7.17**: Boss阶段提示，狂暴/绝望触发"狂 暴"/"绝 望"全屏火焰大字(reason:phase)，content_test修复(42成就/6里程碑)

*测试基线: 42 smoke + 8 wave + 236 content + 11 stress + 5 robust + 3 seeded*

*v7.0-v7.18 更新于 2026-05-31。*
