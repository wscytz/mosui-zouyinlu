...
- **测试基线**: 201 项全绿 (37 smoke + 5 wave + 149 content + 10 stress)
- **内容体量**: 5武器 / 109遗物 / 25进化 / 32敌人(3Boss) / 9关卡 / 22誓印 / 37成就 / 12波
...
### v4.21-v4.22 深度补完 ✅ (当前)
- v4.21: 墨火眼(爆炸/火)+墨符坛(持续/法术)+墨魂丹(生命/爆发) + 墨蛛后(召唤型精英)
- v4.22: 2新成就(绝地逢生/蛛后克星) + BUILD_PREFS标签补全(持续/生命/防御/诅咒/攻速)
