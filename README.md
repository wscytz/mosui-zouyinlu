...
## v9.3-v10.0 视觉升级 + 第4难度 (2026-06-01)

- **v10.0 视觉升级 6 任务**：结算截图生成（Canvas→PNG）/ 9 敌人画像补全(47/47)/ 粒子效果升级(暴击+Boss击杀+连杀)/ 5 武器攻击视觉差异化 / 战斗回放(近5局 localStorage) / 本地排行榜(评级+分数前20)
- **v9.4 炼狱难度**：第4难度(hpM 2.0/spdM 1.4/dmgM 1.55)，玩家 HP 倍率 0.7 + 遗物上限 5，calcGrade +30，新成就"炼狱行者"
- **v9.3 Boss 行为微调**：画皮 HP<60% 分身 / 墨将军 8 秒盾空窗 / 墨鬼王 phase 3 8 方向朝玩家弹
